...
print("Welcome to the Taco Truck.")
print(dashes)
...
while place_order:
    ...
    menu_category = input("Please type a menu number: ")
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("Select and item number: ")
...
for items in order_list:
    ...
    print(f"{item_name}{name_spaces}|${price}{price_spaces}|  {item_quantity}")
...
print(dashes)
print(f"Your grand total is ${total_cost:.2f}")
